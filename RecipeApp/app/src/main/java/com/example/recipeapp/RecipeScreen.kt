    ...
    Box(modifier = Modifier.fillMaxSize()){
        when{
            ...
            viewstate.error!=null-> {
                ...
                CategoryScreen(categories = viewstate.categories,navigateToDetails);
            }
        }
    }
}
...
fun CategoryItem(category: Category,navigateToDetails:(Category)->Unit){
    Column(modifier = Modifier.padding(8.dp).fillMaxSize().clickable {navigateToDetails(category)},
