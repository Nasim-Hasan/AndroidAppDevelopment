...
fun FirstScreen(navigationToSecondScreen: (String,Int) -> Unit) {
        ...
        horizontalAlignment = Alignment.CenterHorizontally)
    {
        ...
        Spacer(modifier = Modifier.height(16.dp));
        OutlinedTextField(value =age.intValue.toString(), onValueChange ={age.intValue=it.toInt()});
        Spacer(modifier = Modifier.height(16.dp));
...
@Composable
fun NavigationFirstDemoPreview() {
    NavigationDemoTheme {
        val mockNavigation: (String, Int) -> Unit = { arg1, arg2 ->
            println("Navigating with arguments: $arg1, $arg2");
        }
        FirstScreen (mockNavigation);
    }
}